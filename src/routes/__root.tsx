    ...
    <div className="flex min-h-[70vh] items-center justify-center px-4">
      <div className="glass max-w-md rounded-3xl p-10 text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          That route doesn&apos;t exist in this system.
        </p>
        <div className="mt-6">
          <Link
            to="/"
  ...
  head: () => ({
    meta: [
      ...
      { title: "Souradip Roy Chowdhury | AI & Web Developer" },
      {
        name: "description",
        content:
          "Computer Science & Engineering student building AI assistants, interactive web applications, chatbots, gesture-based interfaces, and innovative digital experiences.",
      },
      { name: "author", content: "Souradip Roy Chowdhury" },
